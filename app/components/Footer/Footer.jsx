        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.brandSection}>
            ...
            <p className={styles.description}>
              ...
              around the world. Join our community of readers and creators.
            </p>
          ...
          <div className={styles.categoriesSection}>
            ...
            <div className={styles.linksList}>
              <Link href="/blog?cat=tech" className={styles.link}>
                Technology
              </Link>
              ...
              <Link href="/blog?cat=music" className={styles.link}>
                Music
              </Link>
            </div>
          </div>
